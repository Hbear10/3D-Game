...
def scan(grid:list, pos1:tuple, pos2:tuple, wall_val:int =1) -> bool:
    ...
    #print(f"{x_direction=}, {y_direction=}, {pos2[0]-pos1[0]=}")
    ...
    while travel_distance < point_distance: 
        ...
        scan_ray_pos[0] += sin(angle)*step_size #How far the ray move ,no x_direction because sine graph isn't symetrical
        scan_ray_pos[1] += cos(angle)*step_size*y_direction
...
if __name__ == "__main__":
    ...
    print(scan(map, (1.5,1.5), (3.5,3.5)))
